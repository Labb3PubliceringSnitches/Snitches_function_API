...
using Snitching_function_API.Models;
using Microsoft.Azure.Cosmos;

namespace Snitching_function_API
{
    public static class SnitchesStoryFunction
    {
        ...
        private static Container container = cosmosClient.GetContainer("SnitchHereDB", "SnitchesStories");
